...
RSpec.describe "/v1/questions", type: :request do
  ...
  # V1::Question. As you add validations to V1::Question, be sure to
  ...
  # V1::QuestionsController, or in your router and rack
  ...
  describe "GET /index" do
    it "renders a successful response" do
      V1::Question.create! valid_attributes
  ...
  describe "GET /show" do
    it "renders a successful response" do
      question = V1::Question.create! valid_attributes
  ...
  describe "POST /create" do
      ...
      it "creates a new V1::Question" do
        expect {
          post v1_questions_url,
               params: { v1_question: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "does not create a new V1::Question" do
        expect {
          post v1_questions_url,
               params: { v1_question: invalid_attributes }, as: :json
        }.to change(V1::Question, :count).by(0)
      end

      it "renders a JSON response with errors for the new v1_question" do
        post v1_questions_url,
             params: { v1_question: invalid_attributes }, headers: valid_headers, as: :json
